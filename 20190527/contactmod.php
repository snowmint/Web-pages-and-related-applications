...
if (isset($Confirm)) {   // 確認按鈕
    ...
    if (!isset($GroupID) || empty($GroupID) || $GroupID<>addslashes($GroupID)) 
        $ErrMsg = '群組資料錯誤\n';
    if (!isset($Birthday) || empty($Birthday)) $ErrMsg = '生日不可為空白\n';
    ...
    // Demo for the reason to use addslashes
        ...
        $sqlcmd="UPDATE namelist SET name='$Name',phone='$Phone',groupid='$GroupID', birthday ='$Birthday', address='$Address' WHERE cid='$cid'";
...
<tr>
    <th>生日</th>
      <td>
        <input type="date" name="Birthday" value="<?php echo $Birthday ?>" size="20">
      </td>
</tr>
<tr height="30">
  <th>電話</th>
